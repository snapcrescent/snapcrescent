...
CREATE TABLE IF NOT EXISTS `album_asset_assn` (  
  ...
  CONSTRAINT `fk_album_asset_assn_album_id` FOREIGN KEY (`album_id`) REFERENCES `album`(`id`),
  CONSTRAINT `fk_album_asset_assn_asset_id` FOREIGN KEY (`asset_id`) REFERENCES `asset`(`id`)
);
