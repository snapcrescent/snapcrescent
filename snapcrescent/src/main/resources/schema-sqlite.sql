...
-- Table: photo
CREATE TABLE IF NOT EXISTS photo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, metadata_id INTEGER NOT NULL REFERENCES metadata (id), thumbnail_id INTEGER NOT NULL REFERENCES thumbnail (id), favorite BOOLEAN DEFAULT (false) );
...
--Table: Album
CREATE TABLE IF NOT EXISTS album (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR (255) NOT NULL, created_date DATETIME (6));
