...
class _AssetStore with Store {
  ...
  _getUnifiedAssetsFromLocalAssets(AssetSearchCriteria searchCriteria,
    ...
    if (album != null) {
      final allAssets = await album.getAssetListPaged(
          page: searchCriteria.pageNumber!,
          size: searchCriteria.resultPerPage!);
      ...
      for (final asset in allAssets) {
        ...
        if (metadata == null) {
          ...
          List<Metadata>? matchingMetadataList =
              await MetadataService().findByName(asset.title!);
