...
class Constants {
  ...
  static const int defaultAutoBackupFrequency = 1 * 60 * 24;
...
enum AssetSearchProgress { IDLE, PROCESSING, ASSETS_FOUND }

enum AssetSource { CLOUD, DEVICE }
...
enum AutoBackupFrequencyType { DAYS, WEEKS }

enum FreeUpSpaceType { ALL, XOLD }
